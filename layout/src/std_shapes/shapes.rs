...
pub struct Arrow {
    ...
    pub head_label: Option<ShapeContent>,
    pub tail_label: Option<ShapeContent>,
    pub look: StyleAttr,
    pub properties: Option<String>,
...
impl Default for Arrow {
    fn default() -> Arrow {
        Arrow {
            ...
            text: Option::None,
            head_label: Option::None,
            tail_label: Option::None,
            look: StyleAttr::simple(),
            properties: Option::None,
...
impl Arrow {
    pub fn reverse(&self) -> Arrow {
        Arrow {
            ...
            head_label: self.tail_label.clone(),
            tail_label: self.head_label.clone(),
